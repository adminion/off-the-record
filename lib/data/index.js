...
function OffTheRecord_data () {
    ...
    this.relationships = Accounts.relationships;
    this.FRIENDS = Accounts.FRIENDS;
    this.FRIENDS_OF_FRIENDS = Accounts.FRIENDS_OF_FRIENDS;
    this.NOT_FRIENDS = Accounts.NOT_FRIENDS;
    ...
    this.search = function (user, term, options, done) {
        ...
        var conditions = {
            ...
            'privacy.search' : { '$gte' : Accounts.model.privacy.FRIENDS }
        };
        ...
        Accounts.model.getFriends(user._id, function (err, friends) {
            ...
            if (friends.length > 0) {
                ...
                friends.forEach(function (friend) {
                    ...
                    conditions['privacy.search'] = { '$gte': Accounts.model.privacy.FRIENDS_OF_FRIENDS }
        ...
        function nonFriendsSearch () {
            conditions['privacy.search'] = { '$gte' : Accounts.model.privacy.ANYBODY };
            debug('conditions', conditions)
