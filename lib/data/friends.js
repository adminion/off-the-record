...
module.exports = function (accountRef) {
     ...
     */
    function friendshipPlugin (schema, pluginOpts) {

        schema.add({
            privacy: {
                profile:        { type: Number, min: privacy.NOBODY, max: privacy.ANYBODY, default: privacy.NOBODY },
                search:         { type: Number, min: privacy.NOBODY, max: privacy.ANYBODY, default: privacy.NOBODY },
                chatRequests:   { type: Number, min: privacy.NOBODY, max: privacy.ANYBODY, default: privacy.NOBODY },
                friendRequests: { type: Number, min: privacy.NOBODY, max: privacy.ANYBODY, default: privacy.NOBODY },
            }
        });
