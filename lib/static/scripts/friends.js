...
$(document).ready(function documentReady () {
  ...
  client.on('requests:received:accepted', function (from) {

    alert('You accepted ' + from + '\'s friend request');

  });

  client.on('requests:sent:accepted', function (to) {

    alert('You accepted ' + from + '\'s request');
