...
var OffTheRecord_db = require('./db.js'),
...
function OffTheRecord_data (keyRing) {
    ...
    this.start = function () {
        ...
        db = new OffTheRecord_db(keyRing.config.mongodb, passport);
    ...
    this.getPerson = function (personID) {
        ...
        // debug.emit('val', 'People.byID', People.byID);
    ...
    this.getTalk = function (talkID) {
        ...
        //debug.emit('val', 'Talks.byID[' + talkID + ']', Talks.byID[talkID]);
...
util.inherits(OffTheRecord_data, events.EventEmitter);
