...
let defaults = require(defaultsFile);
...
if (config.http.session.secret === defaults.http.session.secret) {
  console.log(`WARNING: The default session "secret" is a misnomer! Use at your own risk!`)
}
