...
var defaultsFile = path.join(process.env.OTR_PREFIX, 'config/default.json');
debug('defaultsFile:', defaultsFile);

var CONFIG_DIR = process.env.OTR_CONFIG_DIR || path.join(process.env.OTR_PREFIX, 'config');
...
var nodeEnv = process.env.NODE_ENV.toLowerCase() || 'development';
